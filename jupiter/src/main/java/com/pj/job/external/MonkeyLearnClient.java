package com.pj.job.external;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.pj.job.entity.ExtractRequestBody;
import com.pj.job.entity.ExtractResponseItem;
import com.pj.job.entity.Extraction;
...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "f37d18b0075777afb3dc56a70c4a125c38de6ac7";
    ...
    public List<Set<String>> extract(List<String> articles) {
        ...
        ResponseHandler<List<Set<String>>> responseHandler = response -> {
            ...
            ExtractResponseItem[] results = mapper.readValue(entity.getContent(), ExtractResponseItem[].class); // 数据从哪来， 以什么形式
